...
BUCKET_NAME = "taxi-rides-ny-demo"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "/workspaces/data_engineering_zoomcamp/03-data-warehouse/service-account.json"
...
def download_file(month):
    """Just return the local parquet file path; do NOT download from internet."""
    ...
    if os.path.exists(file_path):
        ...
        print(f"Missing local file: {file_path}, skipping this month.")
        return None
